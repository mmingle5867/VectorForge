...
export const TUNING_EXPORT_RANGES: Record<TuningExportSettingKey, TuningExportRange> = {
  ...
  rasterSourcePaddingPx: { min: -100, max: 200, step: 1 },
...
export const TUNING_EXPORT_HELP: Record<TuningExportSettingKey, string> = {
  ...
  rasterSourcePaddingPx: 'Positive values add margin around the raster before tracing/export. Negative values crop inward.',
